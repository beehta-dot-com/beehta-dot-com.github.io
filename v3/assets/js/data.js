/* ============================================================
   ...
   allowEmbed    bool     Whether demoUrl is known to permit
                           ...
                           preview pane shows a fallback + "Open
   ...
   color         string   Icon tile background (dark-theme tint).
...
const CATEGORY_STYLES = {
  Productivity: { color: "#4DA6FF" },
  Finance:      { color: "#3ED598" },
  Utilities:    { color: "#FF9F45" },
  Social:       { color: "#FF6FA8" },
  Security:     { color: "#A78BFA" },
  Experimental: { color: "#9AA3B7" },
};
...
const APPS = [
  {
    ...
    logo: `<svg viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="7" y="9"  width="16" height="3" rx="1.5" fill="#FF4FA3" opacity="0.3"/>
      <rect x="7" y="15" width="22" height="3" rx="1.5" fill="#FF4FA3" opacity="0.6"/>
      <rect x="7" y="21" width="13" height="3" rx="1.5" fill="#FF4FA3" opacity="0.85"/>
      <circle cx="28" cy="28" r="7" fill="#FF4FA3"/>
      <path d="M24.5 28l2.8 2.8L31.5 24" stroke="#12161F" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>`,
  },
  {
    id: 2,
    ...
    iconColor: "#A78BFA",
    logo: `<svg viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="19" cy="19" r="13" stroke="#A78BFA" stroke-width="2.5" opacity="0.3"/>
      <circle cx="19" cy="19" r="13" stroke="#A78BFA" stroke-width="2.5" stroke-dasharray="30 52" stroke-linecap="round"/>
      <path d="M19 9v2M19 27v2" stroke="#A78BFA" stroke-width="2" stroke-linecap="round"/>
      <path d="M14.5 15h6a2.5 2.5 0 0 1 0 5h-3a2.5 2.5 0 0 0 0 5h6" stroke="#A78BFA" stroke-width="2" stroke-linecap="round"/>
    </svg>`,
  },
  {
    id: 3,
    ...
    iconColor: "#4DA6FF",
    logo: `<svg viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
      <rect x="7" y="5" width="22" height="28" rx="3.5" fill="#4DA6FF" opacity="0.12"/>
      <rect x="7" y="5" width="22" height="28" rx="3.5" stroke="#4DA6FF" stroke-width="2.2"/>
      <path d="M12 14h14M12 19h14M12 24h9" stroke="#4DA6FF" stroke-width="2" stroke-linecap="round"/>
      <circle cx="27" cy="8" r="5.5" fill="#4DA6FF"/>
      <path d="M24.5 8h5M27 5.5V11" stroke="#101F30" stroke-width="1.8" stroke-linecap="round"/>
    </svg>`,
  },
  {
    id: 4,
    ...
    iconColor: "#FFC24D",
    logo: `<svg viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle cx="19" cy="15" r="6" fill="#FFC24D" opacity="0.9"/>
      <path d="M19 5v3M19 24v3M8 15H5M32 15h-3M11.5 7.5l2 2M25.5 23.5l2 2M25.5 7.5l-2 2M11.5 23.5l-2 2" stroke="#FFC24D" stroke-width="2" stroke-linecap="round"/>
      <path d="M7 30c0-3.5 2.5-6 6-6 1.2 0 2.3.35 3.2.95C17 23.37 18.8 22 21 22c3.3 0 6 2.7 6 6" stroke="#FFC24D" stroke-width="2" stroke-linecap="round" opacity="0.5"/>
    </svg>`,
  },
];
