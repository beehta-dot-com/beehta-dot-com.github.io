...
const APPS = [
  {
    ...
    description: "Share files and text bbetween devices connected through same LAN / Wi-Fi.",
    category: "Utilities",
  ...
  },
  {
    ...
    description: "Manage all the logins at one place wiothout having to save password but through password hints",
    category: "Utilities",
